...
// Color constant values used in the app
const Color primaryColor = Color(0xFF07B150);
const Color secondaryColor = Color(0xFF20603B);
const Color accentColor = Color(0xFFFAF117);
